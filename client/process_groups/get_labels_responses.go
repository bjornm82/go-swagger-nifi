...
/*GetLabelsForbidden handles this case with default header values.
...
/*GetLabelsNotFound handles this case with default header values.
...
/*GetLabelsConflict handles this case with default header values.
