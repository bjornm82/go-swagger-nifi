...
func (o *SubmitValidationRequestCreated) GetPayload() *models.ParameterContextValidationRequestEntity {
	return o.Payload
}
...
/*SubmitValidationRequestBadRequest handles this case with default header values.
...
/*SubmitValidationRequestUnauthorized handles this case with default header values.
...
/*SubmitValidationRequestForbidden handles this case with default header values.
...
/*SubmitValidationRequestNotFound handles this case with default header values.
...
/*SubmitValidationRequestConflict handles this case with default header values.
