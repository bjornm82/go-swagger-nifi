...
/*DeleteValidationRequestOK handles this case with default header values.
...
/*DeleteValidationRequestBadRequest handles this case with default header values.
...
/*DeleteValidationRequestUnauthorized handles this case with default header values.
...
/*DeleteValidationRequestForbidden handles this case with default header values.
...
/*DeleteValidationRequestNotFound handles this case with default header values.
...
/*DeleteValidationRequestConflict handles this case with default header values.
