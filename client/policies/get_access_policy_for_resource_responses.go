...
/*GetAccessPolicyForResourceOK handles this case with default header values.
...
/*GetAccessPolicyForResourceBadRequest handles this case with default header values.
...
/*GetAccessPolicyForResourceUnauthorized handles this case with default header values.
...
/*GetAccessPolicyForResourceForbidden handles this case with default header values.
...
/*GetAccessPolicyForResourceNotFound handles this case with default header values.
...
/*GetAccessPolicyForResourceConflict handles this case with default header values.
