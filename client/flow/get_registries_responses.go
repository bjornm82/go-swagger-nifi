...
/*GetRegistriesBadRequest handles this case with default header values.
...
/*GetRegistriesNotFound handles this case with default header values.
...
/*GetRegistriesConflict handles this case with default header values.
