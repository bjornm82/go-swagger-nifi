...
/*GetSystemDiagnosticsOK handles this case with default header values.
...
/*GetSystemDiagnosticsUnauthorized handles this case with default header values.
...
/*GetSystemDiagnosticsForbidden handles this case with default header values.
