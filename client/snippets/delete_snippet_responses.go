...
/*DeleteSnippetUnauthorized handles this case with default header values.
...
/*DeleteSnippetForbidden handles this case with default header values.
...
/*DeleteSnippetConflict handles this case with default header values.
