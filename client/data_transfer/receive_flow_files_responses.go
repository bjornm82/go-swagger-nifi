...
func (o *ReceiveFlowFilesCreated) GetPayload() string {
	return o.Payload
}
...
/*ReceiveFlowFilesBadRequest handles this case with default header values.
...
/*ReceiveFlowFilesUnauthorized handles this case with default header values.
...
/*ReceiveFlowFilesForbidden handles this case with default header values.
...
/*ReceiveFlowFilesNotFound handles this case with default header values.
...
/*ReceiveFlowFilesConflict handles this case with default header values.
...
/*ReceiveFlowFilesServiceUnavailable handles this case with default header values.
