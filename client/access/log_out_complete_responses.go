...
/*LogOutCompleteOK handles this case with default header values.
...
/*LogOutCompleteUnauthorized handles this case with default header values.
...
/*LogOutCompleteInternalServerError handles this case with default header values.
